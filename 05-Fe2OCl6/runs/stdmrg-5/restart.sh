...
export PYSCF_TMPDIR=/central/scratch/hczhai/hife/fe2ocl6-def2-SVP-uks.1/runs/stdmrg-5
...
if [ "$?" = "1" ] || [ "${SLURM_TASKS_PER_NODE}" = "" ] || [ "0" = "1" ]; then
    if [ "0" = "1" ]; then
        ...
        ln -s /central/scratch/hczhai/hife/fe2ocl6-def2-SVP-uks.1/runs/stdmrg-5/FCIDUMP ./FCIDUMP
        cp /central/scratch/hczhai/hife/fe2ocl6-def2-SVP-uks.1/runs/stdmrg-5/${SCPT}.conf ${SCPT}.conf.${TJ}
...
if [ "0" = "1" ]; then
    cp /central/scratch/hczhai/hife/fe2ocl6-def2-SVP-uks.1/runs/stdmrg-5/node0/1pdm.npy ${SCPT}.1pdm.${TJ}.npy
fi