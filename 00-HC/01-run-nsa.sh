#!/bin/bash
#SBATCH --job-name ST00-01-NSA
#SBATCH -o ST00-01-NSA-%N.%j.out
#SBATCH --nodes=4
...
orterun --map-by ppr:$SLURM_TASKS_PER_NODE:node:pe=$OMP_NUM_THREADS python3 -u 01-dmrg-nsa.py > 01-dmrg-nsa.out
