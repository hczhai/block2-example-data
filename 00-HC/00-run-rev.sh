#!/bin/bash
#SBATCH --job-name ST00-00-rev
#SBATCH -o ST00-00-rev-%N.%j.out
#SBATCH --nodes=4
...
orterun --map-by ppr:$SLURM_TASKS_PER_NODE:node:pe=$OMP_NUM_THREADS python3 -u 00-dmrg-rev.py > 00-dmrg-rev.out
